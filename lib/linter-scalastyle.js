...
module.exports = {
  ...
  provideLinter: () => {
    ...
    const regex = '(?<type>error|warning) file=(?<file>\\S+) message=(?<message>.*) line=(?<line>\\d+) column=(?<column>\\d+)';
    ...
    return {
      ...
      lint: textEditor => {
        ...
        return helpers.exec(this.scalastyleExecutablePath, args, {stream: 'stdout'})
